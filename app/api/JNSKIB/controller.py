    ...
    def get(self, id):
        ...
        try:
            sqlQuery = (
                ...
                f"WHERE p.UNITKEY = (SELECT TOP 1 l.UNITKEY FROM JNSKIB l WHERE l.id = {id}) AND p.KDPOSTTD = '1';"
                ...
                f"l.ID as id_JNSKIB, l.[IDBRG], l.[UNITKEY], l.[ASETKEY], l.[KDUNIT], l.[NMUNIT], "
                ...
                f"FROM JNSKIB l LEFT OUTER JOIN SensusTanah s "
                f"ON l.ID = s.id_JNSKIB "
                f"WHERE l.ID = {id}"
            )
            ...
            if result:
                ...
                resultFinal['id'] = result[0]['id_JNSKIB']
