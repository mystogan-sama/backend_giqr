...
class List(Resource):
    ...
    def get(self):
        ...
        # Assuming you have a SQLAlchemy model named DAFTUNIT
    ...
    def get(self, id):
        ...
        try:
            sqlQuery = (
                ...
                f"FROM DAFTUNIT AS l "
                f"LEFT JOIN PEGAWAI AS p ON l.UNITKEY = p.UNITKEY "
                f"WHERE p.UNITKEY = (SELECT TOP 1 l.UNITKEY FROM DAFTUNIT l WHERE l.id = {id}) AND p.KDPOSTTD = '1';"
                ...
                f"l.ID as id_DAFTUNIT, l.[IDBRG], l.[UNITKEY], l.[ASETKEY], l.[KDUNIT], l.[NMUNIT], "
                ...
                f"FROM DAFTUNIT l LEFT OUTER JOIN SensusTanah s "
                f"ON l.ID = s.id_DAFTUNIT "
                f"WHERE l.ID = {id}"
            )
            ...
            if result:
                ...
                resultFinal['id'] = result[0]['id_DAFTUNIT']
